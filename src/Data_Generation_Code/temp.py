...
from src.Data_Generation_Code.models import * # Assuming models contain all necessary classes
...
def generate_data(data):
        ...
        def generate_companies():
            ...
            for i in range(NUM_COMPANIES):
                ...
                company = Company(
                    ...
                    operates_in=operates_in,  # Cities where operators exist
                ...
                for city_id in operates_in:
                    city_list[city_id - 1].list_of_companies.append(company.company_id)
        ...
        def generate_operators():
            ...
            for i in range(NUM_OPERATORS):
                ...
                operator = Operator(
                    ...
                    registered_address=f"Address_{i + 1}",
                    #cities in which there is atleast one company
                    operates_in=[],
                    list_of_stores=[]
                )
                ...
                # Update the list_of_operators for each city the operator operates in
        ...
        def generate_stores():
            ...
            for operator in operators:
                for city_id in operator.operates_in:
                    # Generate stores only in cities where the operator operates
                    ...
                    for k in range(NUM_STORES_PER_OPERATOR):  # Create stores for this operator in this city
                        ...
                        # Add the store to the operator's list_of_stores and increment store_id
  ...
  # Populate available drivers list
            ...
            for city in city_list:
                ...
                for i in range(1, number_of_requests_in_city + 1):
                    ...
                    request = Request(
                        ...
                        company_id=random.choice(city.list_of_companies),
        ...
        output_directory = f"Hyperlocal/Data/Generated_datasets_and_input_instance/Instance_{Index_Of_Config}/Generated_data"
